...
const TodoList = ()=>{
    ...
    const todoItems = [
        ...
        {
            id: 3,
            text: "Process pending orders and prepare them for shipment.",
            completed: false
        },
        {
            id: 4,
            text: "Pack and dispatch orders scheduled for delivery.",
            completed: false
        },
        {
            id: 5,
            text: "Review low-stock products and update inventory levels.",
            completed: false
        },
        {
            id: 6,
            text: "Check cancelled and returned orders for required actions.",
            completed: false
        },
        {
            id: 7,
            text: "Review customer feedback and respond to pending reviews.",
            completed: false
        },
        {
            id: 8,
            text: "Verify product listings, prices, and available variants.",
            completed: true
        },
        {
            id: 9,
            text: "Review today's sales and order performance.",
            completed: true
        },
        {
            id: 10,
            text: "Check pending payments and resolve failed transactions.",
            completed: true
        }
    ];
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=components_1_mk9j9._.js.map