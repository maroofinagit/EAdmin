...
interface AddColorSheetProps {
    ...
    onColorUpdate: ({ newName, oldName, oldHex, newHex }: { newName: string; oldName: string; oldHex: string; newHex: string }) => void;
}
...
export function EditColorSheet({
    ...
    const handleSubmit = async (e: React.SubmitEvent<HTMLFormElement>) => {
        ...
        onColorUpdate({ newName: trimmedName, oldName: color?.name || "", oldHex: color?.hex || "", newHex: trimmedHex });
        ...
        <Sheet open={open} onOpenChange={handleOpenChange}>
            <SheetContent className="pt-6 pb-12 px-4">
                <SheetHeader>
                    ...
                    <SheetDescription>
                        Update the details of the selected color.
                    </SheetDescription>
                </SheetHeader>
